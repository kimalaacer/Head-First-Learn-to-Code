...
# we will compile the viewer code
from tkinter import *
import model
...
def setup():
    ...
    grid_view = Canvas(root,
                        width=model.width*cell_size, height=model.height*cell_size,
                        borderwidth=0,
...
# this is the code for the choice handler. it referes to load_pattern function that will have to define
...
# this is the code from start_handler.py
